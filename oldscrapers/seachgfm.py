...
class gfm_Spider(scrapy.Spider):
  ...
  def start_requests(self):
    ...
    while self.i <= 100: 
      url1 = "https://www.gofundme.com/mvc.php?route=homepage_norma/load_more&page=%s&term=a&country=&postalCode=&locationText=" %(self.i) # you can prob just make load more pages high and not have to worry about iterating 
